...
var AppComponent = (function () {
    ...
    AppComponent.prototype.getRows = function (params) {
        ...
        this._elasticService.getRowsDefault(this.sizeOfPage).subscribe(function (res) {
    ...
    AppComponent.prototype.search = function (input) {
        var _this = this;
        this.gridOptions.api.showLoadingOverlay();
        var internalSearch = function (params) {
            _this._elasticService.search(input, _this.sizeOfPage).subscribe(function (res) {
                var data3 = _this.elasticLogProcessing(res);
                _this.gridOptions.api.hideOverlay();
